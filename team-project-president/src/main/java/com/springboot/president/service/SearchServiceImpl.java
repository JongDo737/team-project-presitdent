...
public class SearchServiceImpl implements SearchService{
	...
	@Override
	public SearchForumsRespDto searchForums(String query, int target, String startPeriod, String endPeriod) {
	...
	@Override
	public SearchPetitionRespDto searchPetitions(String query, int target, String startPeriod, String endPeriod) {
